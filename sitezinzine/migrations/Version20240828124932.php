 ...
 */
final class Version20240828124932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_F0225CF4A76ED395 ON emission (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F0225CF4A76ED395 ON emission');
